...
public class MapController: UIViewController, UISearchBarDelegate {
    ...
    private class SearchAnnotation: NSObject, MKAnnotation  {

        public let card: SearchPlaceCard
        public var isValidLoactio: Bool {
        ...
        public var coordinate: CLLocationCoordinate2D {
            return CLLocationCoordinate2D(latitude: card.location.latitude, longitude: card.location.longitude)
        }
