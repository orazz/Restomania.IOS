...
public class EventsAdapter<Handler> : ILoggable, IEventsEmitter
{
    ...
    public func Setup(action: @escaping Action<Handler>, auto: Bool) -> Void
    {
        _defaultAction = action
        _automatic = auto
    }
    public func Subscribe(guid: String, handler: Handler, tag: String) -> Void
    {
    ...
    public func Unsubscribe(guid: String) -> Void
    {
    ...
    private func ForceUnsubscribe(guid: String) -> Void
    {
        Unsubscribe(guid: guid)
        Log.Warning(Tag, "Force remove subscriber with GUID: \(guid).")
    }
    
    public func Trigger(action: Action<Handler>?) -> Void
    {
    ...
    private func Notify(_ subscriber:Subscriber<Handler>, action: @escaping Action<Handler>) -> Void
    {
