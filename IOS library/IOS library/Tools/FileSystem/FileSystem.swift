...
public class FileSystem
{
    ...
    public func CreateDirectory(_ dirname:String, inCache:Bool ) -> Void
    {
        let root = GetRoot(inCache: inCache)
    ...
    public func SaveTo(_ filename:String, data:String, toCache: Bool ) -> Void
    {
    ...
    public func Remove(_ filename:String, fromCache:Bool ) -> Void
    {
        let root = GetRoot(inCache: fromCache)
